...
class RankByCategoryAdapter(val context: Context, var mList: List<FetchRankByCategoryModelClass.FetchRankByCategoryModelClassItem>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        item.rank.text = mList[position].name
    ...
    private class ItemHolder(itemView: View) {
        val rank = itemView.findViewById(R.id.tv_rfid) as TextView
